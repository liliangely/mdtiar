...
student(kowalska, ala, fizyka, 1998).
...
student(lewandowski, marek, kognitywistyka, 1998).
student(jurkowska, barbara, kognitywistyka, 1994).
student(lawendowka, maria, kognitywistyka, 1993).
student(markowska, beata, kognitywistyka, 1994).


szukajstudenta(X,Y):-student(X,Y,informatyka,_).
